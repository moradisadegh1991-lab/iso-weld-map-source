  ...
  },
  {
    ...
    items: [
      ...
      { href: "/equipment", icon: "⚙", title: "تجهیزات", desc: "تگ‌ها و زنجیرهٔ پیش‌نیاز",
        need: ACTIONS.VIEW_PROJECT, status: "live" },
      { href: "/civil", icon: "▩", title: "سیویل", desc: "فونداسیون و بتن",
        need: ACTIONS.VIEW_PROJECT, status: "soon" },
      { href: "/structural", icon: "⌗", title: "استراکچر", desc: "اسکلت فلزی",
        need: ACTIONS.VIEW_PROJECT, status: "soon" },
      { href: "/electrical", icon: "⌁", title: "برق", desc: "کابل و ترمینیشن",
        need: ACTIONS.VIEW_PROJECT, status: "soon" },
      { href: "/instrumentation", icon: "◎", title: "ابزار دقیق", desc: "لوپ و تست",
        need: ACTIONS.VIEW_PROJECT, status: "soon" },
    ],
  },
  {
