...
export const MODULES = [
  ...
  },
  {
    id: "coating",
    title: "رنگ و عایق",
    subtitle: "سیستم رنگ → آماده‌سازی، DFT، عایق",
    discipline: "coating",
    item: "آیتم رنگ",
    source: "مشخصات رنگ و عایق · لیست خطوط",
    standard: "ISO 8501-1 · ISO 8502-4 · ISO 19840 · ASME B31.3 §345.3.1",
    stages: DOC_FLOW,
    actions: ["EDIT_EXTRACTION", "APPROVE_REGISTER", "ASSIGN_WELD"],
    // Nothing to read from a drawing yet: systems are typed from the spec.
    status: "planned",
    execution: "live",
  },
];
