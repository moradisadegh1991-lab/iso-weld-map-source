 ...
 * @param {Array<{kind: "issue"|"return", qty: number}>} movements
 */
export function lotBalance(lot, movements = []) {
  ...
  return { accepted, issued, returned, netIssued: round3(issued - returned), onHand: round3(accepted - issued + returned) };
}
