...
/** n items of a pool in a reproducible order — the progressive examination's additional welds. */
export function drawFromPool(pool, n, seed) {
  return shuffled(pool, mulberry32(seedFrom(seed))).slice(0, Math.max(0, n));
}
